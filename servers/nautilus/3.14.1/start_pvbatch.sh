...
echo '=========================================================='
echo '   ___ _   _____       __      __       ____  _______  ___'   
echo '  / _ \ | / / _ )___ _/ /_____/ /  ____|_  / <  / / / <  /'
echo ' / ___/ |/ / _  / _ `/ __/ __/ _ \/___//_ <_ / /_  _/ / / '
echo '/_/   |___/____/\_,_/\__/\__/_//_/   /____(_)_/ /_/(_)_/  '
echo '=========================================================='
echo
...
JID=`qsub -S /bin/bash -v MPI_TYPE_MAX,PV_PATH,PATH,LD_LIBRARY_PATH,PV_NCPUS,PV_LOGIN_HOST,PV_BATCH_SCRIPT_PATH -N PV-3.14.1-Batch -A $ACCOUNT -q $QUEUE -l ncpus=$NCPUS,mem=$MEM\MB,walltime=$WALLTIME /sw/analysis/paraview/3.14.1/sles11.1_intel11.1.038/start_pvbatch.qsub`
ERRNO=$?
if [ $ERRNO == 0 ] 
then

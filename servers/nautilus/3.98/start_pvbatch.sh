...
echo '=============================================================='
echo '   ___ _   ____        __      __       ____  ___  ___   ___  '
echo '  / _ \ | / / /  ___ _/ /_____/ /  ____|_  / / _ \( _ ) / _ \ '
echo ' / ___/ |/ / _ \/ _ `/ __/ __/ _ \/___//_ <_ \_, / _  |/ // / '
echo '/_/   |___/_.__/\_,_/\__/\__/_//_/   /____(_)___/\___(_)___/  '
echo '=============================================================='
echo
...
JID=`qsub -S /bin/bash -v MPI_TYPE_MAX -v PV_PATH -v _PATH -v _LD_LIBRARY_PATH -v PV_NCPUS -v PV_LOGIN_HOST -v PV_BATCH_SCRIPT_PATH -N PV-3.98-Batch -A $ACCOUNT -q $QUEUE -l ncpus=$NCPUS,mem=$MEM\MB,walltime=$WALLTIME /sw/analysis/paraview/3.98/sles11.1_intel11.1.038/start_pvbatch.qsub`
ERRNO=$?
if [ $ERRNO == 0 ] 
then

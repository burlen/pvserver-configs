...
MESA=/usr/common/graphics/ParaView/3.10.0-mom
PYTHON=/usr/common/graphics/ParaView/3.10.0-mom
...
cmake \
    ...
    -DCMAKE_INSTALL_PREFIX=/usr/common/graphics/ParaView/3.10.0-mom \
    ...
    -DMPI_EXTRA_LIBRARY=/opt/cray/mpt/5.4.0/xt/gemini/mpich2-gnu/46/lib/libmpl.a\;/opt/cray/ugni/2.3-1.0400.4127.5.20.gem/lib64/libugni.a\;/opt/cray/pmi/3.0.0-1.0000.8661.28.2807.gem/lib64/libpmi.a\;/opt/cray/udreg/2.3.1-1.0400.3911.5.13.gem/lib64/libudreg.a\;/opt/cray/xpmem/0.1-2.0400.30792.5.6.gem/lib64/libxpmem.a\;/opt/cray/dmapp/3.2.1-1.0400.3965.10.63.gem/lib64/libdmapp.a\;/usr/lib/alps/libalpslli.a\;/usr/lib/alps/libalpsutil.a \
    -DBOOST_ROOT=$BOOST \
    -DVTK_USE_BOOST=ON \

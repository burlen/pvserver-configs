...
cmake \
    ...
    -DMPI_EXTRA_LIBRARY=/usr/lib64/librt.a\;/usr/lib64/libpthread.a\;$SMA/libsma.a\;$XPMEM/libxpmem.a\;$DMAPP/libdmapp.a\;$UGNI/libugni.a\;$PMI/libpmi.a\;$ALPS/libalpslli.a\;$ALPS/libalpsutil.a\;$UDREG/libudreg.a\;$MPT/libmpl.a\;$MPT/libmpichcxx_gnu_47.a\; \

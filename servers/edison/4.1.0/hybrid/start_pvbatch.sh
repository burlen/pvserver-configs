...
PV_VER_SHORT=4.1
PV_VER_FULL=4.1.0
PV_HOME=/usr/common/graphics/ParaView/$PV_VER_FULL/hybrid
...
module swap PrgEnv-intel PrgEnv-gnu/5.1.29
...
echo '   ___ _  __/ /  ___ _/ /_____/ /  ____/ / / <  // _ \ '
echo '  / _ \ |/ / _ \/ _ `/ __/ __/ _ \/___/_  _/ / // // / '
echo ' / .__/___/_.__/\_,_/\__/\__/_//_/     /_/(_)_(_)___/  '
echo '/_/                                                    '
echo '======================================================='
echo
